  ...
  const servicesData = [
    {
      ...
      description:
        "Transform your home into a beautiful and functional space. Our expert designers create personalized interiors that reflect your unique style and needs, from concept to completion.",
    ...
    },
    {
      ...
      description:
        "Create a professional and inspiring workspace. We design commercial spaces that enhance productivity, brand identity, and employee well being, tailored to your business.",
    ...
    },
    {
      ...
      description:
        "Visualize your dream space before it's built. Our detailed space planning and realistic 3D visualizations help you see the potential of your interior, ensuring every detail is perfect.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore VastuCraft’s interior design services, offering tailored solutions for residential, commercial, and office spaces."
        />
        <meta
          name="keywords"
          content="Residential interior design , Commercial interior design , Office interior design services"
        />
        <title>Interior Design Services – Homes & Offices</title>
      </Helmet>
